...
# These are shell scape codes, used for formatting
...
# stream. Usually these re both the same thing, but they don't have to
...
# is passed to our script (via fread) when the user press Enter.
...
# They are just "text" like other character, so you can easily copy
...
# use a never-ending loop using while(1). "1" always evaluate to true, so
...
while (1) {
    ...
    # We check that our snake won't step onto or over the frame, to keep t
    # it in its box!
