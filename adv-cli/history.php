...
# start typing a command an then press tab to have it completed, as
...
while (1) {
    ...
    # modern distributions compile it using compatible libedit library
    # for licensing and other reasons. So we will keep a parallel copy of
    # the history in an array for programmatic access.
